...
def time_seams(images: list[ResizeableImage], dp: bool) -> tuple[list[int], list[float]]:
    sizes = []
    times = []
    print(f"{dp=}")
    for image in images:
...
if __name__ == '__main__':
    ...
    given_images = list(map(ResizeableImage, ("sunset_small.png", "sunset_full.png", "cat_fortress_small.jpg")))
